...
CHANNELS_SRC=CHANNELS_SRC_NEW if Settings.get_boolean('channelsrc')else'https://jiotv.data.cdn.jio.com/apis/v1.3/getMobileChannelList/get/?os=android&devicetype=phone&usertype=JIO&version=290&langId=6'
